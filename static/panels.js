...
const MAIN_VIEW_PANELS = ['settings','skills','memory','tasks','activity','kanban','workspaces','profiles','insights','logs','plugin'];
...
async function switchPanel(name, opts = {}) {
  ...
  if (nextPanel === 'activity' && typeof loadJarvizTasks === 'function') await loadJarvizTasks();
